...
public class EmpresaServiceTest {
	...
	public void testBuscarEmpresaPorCnpj() {
		ResponseEntity<Response<EmpresaDTO>> responseEntity = this.empresaService.buscarPorCnpj(CNPJ);
		assertNotNull(responseEntity.getBody().getData());
	}
	
	@Test
	public void testPersistirEmpresa() {
		ResponseEntity<Response<EmpresaDTO>> responseEntity = this.empresaService.persistir(new EmpresaDTO(), new BindingResult() {
